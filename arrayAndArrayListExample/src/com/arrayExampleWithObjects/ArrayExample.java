...
public class ArrayExample {
	...
	public static void main(String[] args) {
		...
		Person1[] person = new Person1[5]; // default initialization is null as it does not refer to any object
											// currently
		System.out.println(person[4]); // null
